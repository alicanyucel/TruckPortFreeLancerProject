...
export class TranslationService {
  ...
  'truckstore.filters.title': { tr: 'Filtrele', en: 'Filter' },
  'truckstore.filter.brand': { tr: 'Marka', en: 'Brand' },
  'truckstore.filter.model': { tr: 'Model', en: 'Model' },
  'truckstore.filter.modelPlaceholder': { tr: 'Model ara...', en: 'Search model...' },
  'truckstore.filter.price': { tr: 'Fiyat', en: 'Price' },
  'truckstore.filter.year': { tr: 'Yıl', en: 'Year' },
  'truckstore.filter.km': { tr: 'Kilometre', en: 'Mileage' },
  'truckstore.button.postAd': { tr: 'İlan Ver', en: 'Post Ad' },
  'truckstore.button.clear': { tr: 'Temizle', en: 'Clear' },
  'truckstore.section.title': { tr: 'Satılık Kamyon ve Römorklar', en: 'Trucks & Trailers for Sale' },
  'truckstore.card.brand': { tr: 'Marka', en: 'Brand' },
  'truckstore.card.model': { tr: 'Model', en: 'Model' },
  'truckstore.card.year': { tr: 'Yıl', en: 'Year' },
  'truckstore.card.km': { tr: 'Km', en: 'Km' },
  'truckstore.card.kmUnit': { tr: 'km', en: 'km' },
  'truckstore.card.details': { tr: 'Detay', en: 'Details' },
  'truckstore.post.title': { tr: 'Yeni İlan Ver', en: 'Post New Ad' },
  'truckstore.post.label.title': { tr: 'Başlık', en: 'Title' },
  'truckstore.post.placeholder.title': { tr: 'Örn: Mercedes Actros 1845 - Çok temiz', en: 'e.g. Mercedes Actros 1845 - Very clean' },
  'truckstore.post.validation.title': { tr: 'Başlık zorunludur.', en: 'Title is required.' },
  'truckstore.post.label.brand': { tr: 'Marka', en: 'Brand' },
  'truckstore.post.placeholder.brand': { tr: 'Örn: Mercedes-Benz', en: 'e.g. Mercedes-Benz' },
  'truckstore.post.validation.brand': { tr: 'Marka giriniz.', en: 'Please enter a brand.' },
  'truckstore.post.label.model': { tr: 'Model', en: 'Model' },
  'truckstore.post.placeholder.model': { tr: 'Örn: Actros 1845', en: 'e.g. Actros 1845' },
  'truckstore.post.validation.model': { tr: 'Model zorunludur.', en: 'Model is required.' },
  'truckstore.post.label.year': { tr: 'Yıl', en: 'Year' },
  'truckstore.post.validation.year': { tr: 'Geçerli bir yıl girin.', en: 'Enter a valid year.' },
  'truckstore.post.label.km': { tr: 'Km', en: 'Mileage' },
  'truckstore.post.validation.km': { tr: 'Km bilgisi zorunludur.', en: 'Mileage is required.' },
  'truckstore.post.label.price': { tr: 'Fiyat', en: 'Price' },
  'truckstore.post.validation.price': { tr: 'Fiyat geçerli ve zorunludur.', en: 'Price is required and must be valid.' },
  'truckstore.post.label.image': { tr: 'Resim Yükle (zorunlu)', en: 'Upload Image (required)' },
  'truckstore.post.help.image': { tr: 'PNG/JPG uygundur. Maksimum 5MB.', en: 'PNG/JPG acceptable. Max 5MB.' },
  'truckstore.post.submit': { tr: 'Gönder', en: 'Submit' },
  'truckstore.post.error.fileTooLarge': { tr: 'Dosya çok büyük. Maksimum 5MB.', en: 'File too large. Max 5MB.' },
  'truckstore.post.error.fillForm': { tr: 'Lütfen formu doğru şekilde doldurun.', en: 'Please fill the form correctly.' },
  'truckstore.post.error.missingFields': { tr: 'Lütfen ilan için gerekli tüm bilgileri ve bir resim ekleyin.', en: 'Please add all required information and an image.' },
  'truckstore.post.success': { tr: 'İlanınız başarıyla eklendi. Satış için iyi şanslar!', en: 'Your post was added successfully. Good luck with the sale!' },
  'truckstore.post.createdTitle': { tr: 'İlan Oluşturuldu', en: 'Post Created' },
  'common.prev': { tr: 'Önceki', en: 'Previous' },
  ...
  // Additional keys used in truckstore new layout & modal
  'truckstore.header.subtitle': { tr: 'Türkiye\'nin En Büyük Kamyon ve Nakliye Araçları Pazarı', en: 'Turkey\'s Largest Truck and Transport Vehicle Marketplace' },
  'truckstore.filter.type.all': { tr: 'Tümü', en: 'All' },
  'truckstore.filter.type.cekici': { tr: 'Çekici', en: 'Tractor' },
  'truckstore.filter.type.kamyon': { tr: 'Kamyon', en: 'Truck' },
  'truckstore.filter.type.romork': { tr: 'Römork', en: 'Trailer' },
  'truckstore.filter.type.yariRomork': { tr: 'Yarı Römork', en: 'Semi-Trailer' },
  'truckstore.button.filter': { tr: 'Filtrele', en: 'Filter' },
  'truckstore.card.priceLabel': { tr: 'Satış Fiyatı', en: 'Sale Price' },
  'truckstore.modal.title': { tr: 'Araç Detayları', en: 'Vehicle Details' },
  'truckstore.modal.seller': { tr: 'İlan Veren', en: 'Seller' },
  'truckstore.modal.sellerName': { tr: 'Ad Soyad', en: 'Name' },
  'truckstore.modal.sellerPhone': { tr: 'Telefon', en: 'Phone' },
  'truckstore.modal.sellerEmail': { tr: 'Email', en: 'Email' },
